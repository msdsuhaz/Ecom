...
@section('body')
        ...
        <div class="container">
            <div class="callbacks_container">
                <ul class="rslides" id="slider">
                    <li><img src="{{ asset('/') }}/front-end/images/slider1.jpg" class="img-responsive" alt=""/></li>
                    <li><img src="{{ asset('/') }}/front-end/images/2.jpg" class="img-responsive" alt=""/></li>
                    <li><img src="{{ asset('/') }}/front-end/images/3.jpg" class="img-responsive" alt=""/></li>
                </ul>
            </div>
        </div>
    </div>
    <div class="content_top">
        <div class="container">
            ...
            <div class="grid_2">
                @foreach($nwproducts as $nwproduct)
                <div class="col-md-3 span_6">
                    <div class="box_inner">
                        <img src="{{ asset($nwproduct->product_image) }}" class="img-responsive" alt=""/>
                        <div class="sale-box"> </div>
                        <div class="desc">
                            <h3>{{$nwproduct->product_name}}</h3>
                            <h4>TK:{{$nwproduct->product_price}}</h4>
                            <ul class="list2">
    ...
    <div class="content_middle">
        <div class="container">
            ...
            <ul id="flexiselDemo3">
                <li><img src="{{ asset('/') }}/front-end/images/n1.jpg"  class="img-responsive" /><div class="grid-flex"><h4>Contrary to popular </h4><p>589,90 $</p>
                        <div class="m_3"><a href="#" class="link2">Add to Cart</a></div>
                        <div class="ticket"> </div>
                    </div></li>
                <li><img src="{{ asset('/') }}/front-end/images/n2.jpg"  class="img-responsive" /><div class="grid-flex"><h4>Contrary to popular </h4><p>589,90 $</p>
                        <div class="m_3"><a href="#" class="link2">Add to Cart</a></div>
                        <div class="ticket"> </div>
                    </div></li>
                <li><img src="{{ asset('/') }}/front-end/images/n3.jpg"  class="img-responsive" /><div class="grid-flex"><h4>Contrary to popular </h4><p>589,90 $</p>
                        <div class="m_3"><a href="#" class="link2">Add to Cart</a></div>
                        <div class="ticket"> </div>
                    </div></li>
                <li><img src="{{ asset('/') }}/front-end/images/n4.jpg"  class="img-responsive" /><div class="grid-flex"><h4>Contrary to popular </h4><p>589,90 $</p>
                        <div class="m_3"><a href="#" class="link2">Add to Cart</a></div>
                        <div class="ticket"> </div>
                    </div></li>
                <li><img src="{{ asset('/') }}/front-end/images/n5.jpg"  class="img-responsive" /><div class="grid-flex"><h4>Contrary to popular </h4><p>589,90 $</p>
                        <div class="m_3"><a href="#" class="link2">Add to Cart</a></div>
                        <div class="ticket"> </div>
                    </div></li>
            </ul>
    ...
    <div class="container">
        <div class="content_middle_bottom">
            ...
            <div class="col-md-8">
                ...
                <div class="a-top">
                    <div class="left-grid">
                        <img src="{{ asset('/') }}/front-end/images/t4.jpg" class="img-responsive" alt=""/>
                    </div>
                ...
                <div class="a-top">
                    <div class="left-grid">
                        <img src="{{ asset('/') }}/front-end/images/t5.jpg" class="img-responsive" alt=""/>
                    </div>
                    <div class="right-grid">
                        <h4><a href="#">Duis autem vel eum iriure dolor in hendrerit</a></h4>
                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat</p>
                ...
                <div class="a-top">
                    <div class="left-grid">
                        <img src="{{ asset('/') }}/front-end/images/t6.jpg" class="img-responsive" alt=""/>
                    </div>
                    <div class="right-grid">
                        <h4><a href="#">Duis autem vel eum iriure dolor in hendrerit</a></h4>
                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat</p>
                ...
                <div class="a-top">
                    <div class="left-grid">
                        <img src="{{ asset('/') }}/front-end/images/t7.jpg" class="img-responsive" alt=""/>
                    </div>
                    <div class="right-grid">
                        <h4><a href="#">Duis autem vel eum iriure dolor in hendrerit</a></h4>
                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat</p>
        ...
        <div class="content_bottom">
            <div class="col-md-3 span_1">
                ...
                <img src="{{ asset('/') }}/front-end/images/t8.jpg" class="img-responsive" alt=""/>
            </div>
            <div class="col-md-3 span_1">
                <ul class="spinner">
                    <i class="bubble"> </i>
