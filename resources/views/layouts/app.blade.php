                ...
                <div id="sidebar-left" class="span2">
                    <div class="nav-collapse sidebar-nav">
                        <ul class="nav nav-tabs nav-stacked main-menu">
                            ...
                            <li><a href="{{route('/addcatagory')}}"><i class="icon-envelope"></i><span class="hidden-tablet"> Add Catagory</span></a></li>
                            <li><a href="{{route('manage-catagory')}}"><i class="icon-tasks"></i><span class="hidden-tablet"> Manage catagory</span></a></li>
                            <li><a href="{{route('add-brand')}}"><i class="icon-eye-open"></i><span class="hidden-tablet">Add Brand</span></a></li>
                            <li><a href="widgets.html"><i class="icon-dashboard"></i><span class="hidden-tablet">Manage Brand</span></a></li>
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a class="submenu" href="{{route('manage-product')}}"><i class="icon-file-alt"></i><span class="hidden-tablet">Manage Product</span></a></li>
